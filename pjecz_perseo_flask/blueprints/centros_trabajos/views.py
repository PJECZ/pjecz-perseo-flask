...
from .forms import CentroTrabajoForm
...
def datatable_json():
    ...
    if "descripcion" in request.form:
        consulta = consulta.filter(CentroTrabajo.descripcion.contains(safe_string(request.form["descripcion"])))
    # Ordenar y paginar
...
def detail(centro_trabajo_id):
    ...
    return render_template("centros_trabajos/detail.jinja2", centro_trabajo=centro_trabajo, nominas_tipos=Nomina.TIPOS)
