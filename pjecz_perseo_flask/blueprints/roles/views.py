...
def list_active():
    ...
    return render_template("roles/list.jinja2", estatus="A", filtros={"estatus": "A"}, titulo="Roles")
...
def list_inactive():
    ...
    return render_template("roles/list.jinja2", estatus="B", filtros={"estatus": "B"}, titulo="Roles inactivos")
