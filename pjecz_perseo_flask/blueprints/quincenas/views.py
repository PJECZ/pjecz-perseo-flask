...
from ..quincenas_productos.models import QuincenaProducto
from ..usuarios.decorators import permission_required
from .forms import QuincenaForm
...
def export_timbrados(nomina_tipo, quincena_id):
    ...
    if nomina_tipo not in ["AGUINALDO", "APOYO ANUAL", "APOYO DIA DE LA MADRE", "SALARIO", "PRIMA VACACIONAL"]:
